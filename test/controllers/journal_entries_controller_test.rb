...
class JournalEntriesControllerTest < ActionController::TestCase
  ...
  test "should create journal_entry" do
    assert_difference('JournalEntry.count') do
      post :create, journal_entry: { account_id: @journal_entry.account_id, amount: @journal_entry.amount, credit: @journal_entry.credit, date: @journal_entry.date, debit: @journal_entry.debit, description: @journal_entry.description, user_id: @journal_entry.user_id }
    end
  ...
  test "should update journal_entry" do
    patch :update, id: @journal_entry, journal_entry: { account_id: @journal_entry.account_id, amount: @journal_entry.amount, credit: @journal_entry.credit, date: @journal_entry.date, debit: @journal_entry.debit, description: @journal_entry.description, user_id: @journal_entry.user_id }
    assert_redirected_to journal_entry_path(assigns(:journal_entry))
  end
