class JournalsController < ApplicationController
  ...
  private
    ...
    def journal_params
      params.require(:journal).permit(:description, :date, :reference, :user_id, journal_entries_attributes: [:id, :description, :amount, :account_id, :gl_account_id, :debit, :credit, :date, :user_id])
    end
end
